...
ending_compile()
{
	...
	mv $nameBinaryZIP "$externalBinariesFolder/$nameBinaryZIP"
	cd ..
...
compile_Linux32()
{
	...
	make CC='gcc -m32' target.arch=i*86 PDINCLUDEDIR=../$pdSourceName/src && make install PDLIBDIR=../$externalFolderARCH
...
compile_Linux64()
{
	...
	make PDINCLUDEDIR=../$pdSourceName/src && make install PDLIBDIR=../$externalFolderARCH
...
compile_armv6()
{
	...
	echo $"====== LINHA 264 - TERMINOU DE SETAR PATH ========"
	echo 

	make CC=arm-linux-gnueabihf-gcc target.arch=armv6 PDINCLUDEDIR=../$pdSourceName/src && make install PDLIBDIR=../$externalFolderARCH
...
compile_armv7()
{
	...
	make CC=arm-linux-gnueabihf-gcc target.arch=arm7l PDINCLUDEDIR=../$pdSourceName/src && make install PDLIBDIR=../$externalFolderARCH extension=l_arm
...
compile_armv8()
{
	...
	make CC=aarch64-linux-gnu-gcc target.arch=arm8-a PDINCLUDEDIR=../$pdSourceName/src && make install PDLIBDIR=../$externalFolderARCH
...
compile_win32()
{
	...
	make PLATFORM=i686-w64-mingw32 PDDIR=../pd-win/$pdSourceName && make install PDLIBDIR=../$externalFolderARCH extension=dll
...
compile_win64()
{
	...
	make PLATFORM=x86_64-w64-mingw32 PDDIR=../pd-win/$pdSourceName && make install PDLIBDIR=../$externalFolderARCH extension=dll
